...
,      
        ...
        ,
            newText("scale_title", "Was the sentence correct?")
            .settings.css("font-size", "30px")
            .print()
        ,
       newScale("rating", 7)
      .settings.slider()
      .settings.before( newText("left", "definitely not") )
      .settings.after( newText("right", " definitely yes") )
      .print()
      .wait()
   ,
    ...
    ,      
        getText("scale_title")
           .remove() 
      ,         
        newText("pleasewait2", "Please wait for the next trial.")
          .print()
    ,
        newTimer("wait", 1000)
            .start()
